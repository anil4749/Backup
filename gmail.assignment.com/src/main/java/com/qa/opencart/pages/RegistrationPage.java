...
public class RegistrationPage {
	...
	public boolean registration(String firstName, String lastName,
		...
		selectSubscriptionOption(subsribe);
		selectAggrementAndContinue();
		return getRestrationStatus();
	
	}
	
	private boolean getRestrationStatus() {
	...
	private void selectAggrementAndContinue() {
		elementUtil.doClick(agreeCheckBox);
		elementUtil.doClick(continueButton);
	}
	
	private void selectSubscriptionOption(String subsribe) {
	...
	private void fillRegForm(String firstName, String lastName,
			String email, String telephone, String password) {
