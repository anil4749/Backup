...
public class CrickInfoTable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(getBowlersStatsList("Shakib Al Hasan"));
	}
	...
	//Need to correct Assignment
	public static List<String> getBowlersStatsList(String bowlerName) {
		String scoreXpath = "//a[text()='"+bowlerName+"']/parent::td/following-sibling::td";
		List<WebElement> scoreList= driver.findElements(By.xpath(scoreXpath));
		List<String> scoreValList = new ArrayList<String>();
		for(int i=1 ; i<scoreList.size();i++) {
			String text = scoreList.get(i).getText();
